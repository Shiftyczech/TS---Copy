"""
Výběr dílu – popup grid to pick a part/accessory (tsd02)
Used from objednavka_dialog when adding a part to the order.
"""
...
class VyberDiluDialog(QDialog):
    def __init__(self, ctx, parent=None):
        super().__init__(parent)
        self.ctx = ctx
        self.setWindowTitle("Výběr dílu")
    ...
    def _build_ui(self):
        ...
        self.table.setHorizontalHeaderLabels(["Číslo", "Název", "Cena", "Symbol"])
    ...
    def _load_data(self):
        self._all_rows = self.ctx.db.read_all("tsd03")
    ...
    def _display(self, rows):
        ...
        for i, r in enumerate(rows):
            ...
            self.table.setItem(i, 3, QTableWidgetItem(str(r.get("SYMBOL", ""))))
        self.table.setSortingEnabled(True)
